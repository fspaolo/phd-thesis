...
\makeatletter
\renewcommand\@makefntext[1]{\leftskip=2em\hskip-2em\@makefnmark#1} % 2em and -2em
\makeatother
...
% Define a command \del, which reduces the spacing of \partial by 1.5mu on the right 
\newcommand{\del}[1][]{\partial\mkern-1.5mu}
...
% suppress 'pp.' before page number
\DeclareFieldFormat{pages}{#1}

% thin spaces between initials
\renewcommand*{\mkbibnamefirst}[1]{{\iffirstinits{\let~\,}{}#1}}

% suppres 'in:' for journal names
\renewbibmacro{in:}{%
  \ifentrytype{article}{}{\printtext{\bibstring{in}\intitlepunct}}}

% to use square brackets instead of parenthesis
...
\setlength{\bibitemsep}{.3cm}

%\setlength{\bibitemsep}{\baselineskip}
\bibliography{thesis}  % global bibliography file
...
\begingroup
\ssp
\printbibliography[segment=1,heading=subbibliography,maxnames=99]
\endgroup
%%
\include{chapter2}
\begingroup
\ssp
\printbibliography[segment=2,heading=subbibliography,maxnames=99]
\endgroup
%%
\include{chapter3}
\begingroup
\ssp
\printbibliography[segment=3,heading=subbibliography,maxnames=99]
\endgroup

\include{chapter4}
\begingroup
\ssp
\printbibliography[segment=4,heading=subbibliography,maxnames=99]
\endgroup
